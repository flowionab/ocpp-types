...
pub struct UnlockConnectorResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for UnlockConnectorResponse<CustomDataType> {
    const ACTION: &'static str = "UnlockConnector";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for UnlockConnectorResponse<CustomDataType> {
...
for UnlockConnectorResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "UnlockConnector";
}
