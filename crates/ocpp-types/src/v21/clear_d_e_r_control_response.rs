...
pub struct ClearDERControlResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for ClearDERControlResponse<CustomDataType> {
    const ACTION: &'static str = "ClearDERControl";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for ClearDERControlResponse<CustomDataType> {
...
for ClearDERControlResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "ClearDERControl";
}
