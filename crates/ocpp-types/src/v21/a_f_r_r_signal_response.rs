...
pub struct AFRRSignalResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for AFRRSignalResponse<CustomDataType> {
    const ACTION: &'static str = "AFRRSignal";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate for AFRRSignalResponse<CustomDataType> {
...
for AFRRSignalResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "AFRRSignal";
}
