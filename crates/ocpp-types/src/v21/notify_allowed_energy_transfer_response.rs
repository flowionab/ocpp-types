...
pub struct NotifyAllowedEnergyTransferResponse<CustomDataType = crate::NoCustomData> {
...
for NotifyAllowedEnergyTransferResponse<CustomDataType> {
...
for NotifyAllowedEnergyTransferResponse<
    CustomDataType,
