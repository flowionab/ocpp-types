...
pub struct SetNetworkProfileResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for SetNetworkProfileResponse<CustomDataType> {
    const ACTION: &'static str = "SetNetworkProfile";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for SetNetworkProfileResponse<CustomDataType> {
...
for SetNetworkProfileResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "SetNetworkProfile";
}
