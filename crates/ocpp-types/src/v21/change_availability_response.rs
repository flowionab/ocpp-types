...
pub struct ChangeAvailabilityResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for ChangeAvailabilityResponse<CustomDataType> {
    const ACTION: &'static str = "ChangeAvailability";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for ChangeAvailabilityResponse<CustomDataType> {
...
for ChangeAvailabilityResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "ChangeAvailability";
}
