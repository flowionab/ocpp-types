...
pub struct NotifyEVChargingScheduleResponse<CustomDataType = crate::NoCustomData> {
...
for NotifyEVChargingScheduleResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "NotifyEVChargingSchedule";
}
