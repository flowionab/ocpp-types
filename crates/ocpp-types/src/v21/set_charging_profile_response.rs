...
pub struct SetChargingProfileResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for SetChargingProfileResponse<CustomDataType> {
    const ACTION: &'static str = "SetChargingProfile";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for SetChargingProfileResponse<CustomDataType> {
...
for SetChargingProfileResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "SetChargingProfile";
}
