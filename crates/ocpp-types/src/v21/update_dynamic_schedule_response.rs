...
pub struct UpdateDynamicScheduleResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for UpdateDynamicScheduleResponse<CustomDataType> {
    const ACTION: &'static str = "UpdateDynamicSchedule";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for UpdateDynamicScheduleResponse<CustomDataType> {
...
for UpdateDynamicScheduleResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "UpdateDynamicSchedule";
}
