...
pub struct UsePriorityChargingResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for UsePriorityChargingResponse<CustomDataType> {
    const ACTION: &'static str = "UsePriorityCharging";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for UsePriorityChargingResponse<CustomDataType> {
...
for UsePriorityChargingResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "UsePriorityCharging";
}
