...
pub struct GetReportResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for GetReportResponse<CustomDataType> {
    const ACTION: &'static str = "GetReport";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate for GetReportResponse<CustomDataType> {
...
for GetReportResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "GetReport";
}
