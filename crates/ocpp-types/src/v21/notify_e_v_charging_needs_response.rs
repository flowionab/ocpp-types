...
pub struct NotifyEVChargingNeedsResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for NotifyEVChargingNeedsResponse<CustomDataType> {
    const ACTION: &'static str = "NotifyEVChargingNeeds";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for NotifyEVChargingNeedsResponse<CustomDataType> {
...
for NotifyEVChargingNeedsResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "NotifyEVChargingNeeds";
}
