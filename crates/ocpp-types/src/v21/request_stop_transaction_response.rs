...
pub struct RequestStopTransactionResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for RequestStopTransactionResponse<CustomDataType> {
    const ACTION: &'static str = "RequestStopTransaction";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for RequestStopTransactionResponse<CustomDataType> {
...
for RequestStopTransactionResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "RequestStopTransaction";
}
