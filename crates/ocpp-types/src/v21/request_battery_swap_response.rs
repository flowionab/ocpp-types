...
pub struct RequestBatterySwapResponse<CustomDataType = crate::NoCustomData> {
...
#[cfg(feature = "alloc")]
impl<CustomDataType> crate::Action for RequestBatterySwapResponse<CustomDataType> {
    const ACTION: &'static str = "RequestBatterySwap";
}
#[cfg(all(feature = "validate", feature = "alloc"))]
impl<CustomDataType> crate::validate::Validate
for RequestBatterySwapResponse<CustomDataType> {
...
for RequestBatterySwapResponse<CustomDataType, STATUS_INFO_ADDITIONAL_INFO_CAP> {
    const ACTION: &'static str = "RequestBatterySwap";
}
